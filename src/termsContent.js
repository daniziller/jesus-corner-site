  ...
  pt: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Pra usar o app, você cria uma conta com nome, e-mail, data de nascimento e uma senha numérica de 6 dígitos. Você é responsável por manter essas informações corretas e por não compartilhar sua senha com terceiros. A data de nascimento é usada pra liberar recursos com restrição de idade — a Comunidade (amigos, grupos e desafios) é disponível só a partir de 16 anos.',
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'To use the app, you create an account with your name, email, date of birth, and a 6-digit numeric password. You\'re responsible for keeping this information accurate and for not sharing your password with others. Your date of birth is used to unlock age-restricted features — the Community (friends, groups, and challenges) is only available from age 16.',
      },
      {
