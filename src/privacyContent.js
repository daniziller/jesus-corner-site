...
export const privacyContent = {
  pt: {
    ...
    sections: [
      ...
      {
        heading: '8. Pagamentos (assinatura Premium)',
        body: 'Quando a assinatura paga do Jesus\' Corner entrar no ar, os dados de pagamento (cartão, etc.) serão processados diretamente por um provedor de pagamentos terceirizado (como Stripe ou Mercado Pago) — nunca armazenamos números de cartão em nossos próprios sistemas. Esta política será atualizada com mais detalhes antes do lançamento dessa funcionalidade.',
      },
      {
      ...
      },
      {
        ...
        body: 'Podemos atualizar esta política conforme o app evolui (por exemplo, ao introduzir um backend próprio ou o processamento de pagamentos). Sempre que isso acontecer, atualizaremos a data no topo desta página.',
      },
      {
        heading: '12. Contato',
  ...
  en: {
    ...
    sections: [
      ...
      {
        heading: '8. Payments (Premium subscription)',
        body: 'When Jesus\' Corner\'s paid subscription goes live, payment data (card numbers, etc.) will be processed directly by a third-party payment provider (such as Stripe or Mercado Pago) — we never store card numbers on our own systems. This policy will be updated with more detail before that feature launches.',
      },
      {
      ...
      },
      {
        ...
        body: 'We may update this policy as the app evolves (for example, if we introduce our own backend or payment processing). Whenever that happens, we\'ll update the date at the top of this page.',
      },
      {
        heading: '12. Contact',
