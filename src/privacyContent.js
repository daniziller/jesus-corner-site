...
export const privacyContent = {
  ...
  en: {
    ...
    sections: [
      ...
      {
        heading: '9. Payments',
        body: 'Jesus\' Corner runs on a subscription — there\'s no free version; see the site for pricing details and what the subscription includes. Payment data (card number, expiration date, etc.) is entered and processed directly by Stripe, our payment provider — we never see or store that data on our own systems. We share with Stripe only what\'s needed to process billing, such as your email and a subscription identifier. In our own database, we store only your subscription status (active, canceled, etc.), the plan you chose (monthly or annual), and its current expiration — never your card details. The price shown (in Brazilian reais or US dollars) is determined automatically from the country detected via your IP address at the time you subscribe. You can cancel anytime from within the app (Profile → Manage subscription), which takes you to a portal hosted directly by Stripe, where you can also update your card on file and download receipts. When you cancel, access to the app continues until the end of the period already paid for (see Terms of Use, section 3).',
      },
      {
