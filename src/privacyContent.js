  ...
  pt: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Como qualquer site, ao acessar o Jesus\' Corner alguns dados técnicos passam pela nossa infraestrutura de hospedagem (Vercel Inc.) — como endereço IP, tipo de navegador e horário de acesso — usados para entregar o conteúdo, sugerir a moeda inicial da assinatura (reais ou dólares, com base no país detectado — você pode trocar manualmente na tela de assinatura) e por segurança. Também carregamos fontes de texto através do Google Fonts, o que envia uma requisição aos servidores do Google, usamos o Supabase Inc. (ver seção 4) para autenticação e armazenamento de dados e usamos o Stripe Inc. (ou, no app instalado por uma loja, o sistema de cobrança da própria loja) para processar o pagamento da sua assinatura (ver seção 9). Nenhum desses dados técnicos é combinado com o conteúdo da sua conta para fins de publicidade.',
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Like any website, when you access Jesus\' Corner some technical data passes through our hosting infrastructure (Vercel Inc.) — such as IP address, browser type, and access time — used to deliver content, suggest an initial subscription currency (Brazilian reais or US dollars, based on your detected country — you can switch it manually on the subscription screen), and for security. We also load fonts through Google Fonts, which sends a request to Google\'s servers, use Supabase Inc. (see section 4) for authentication and data storage, and use Stripe Inc. (or, on the app installed from a store, that store\'s own billing system) to process your subscription payment (see section 9). None of this technical data is combined with your account content for advertising purposes.',
      },
      {
