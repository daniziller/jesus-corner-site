...
export const privacyContent = {
  pt: {
    ...
    sections: [
      ...
      {
        heading: '9. Pagamentos (assinatura Premium)',
  ...
  en: {
    ...
    sections: [
      ...
      {
        heading: '9. Payments (Premium subscription)',
