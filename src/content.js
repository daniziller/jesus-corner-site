export const content = {
  pt: {
    ...
    faq: [
      ...
      { q: 'Meus amigos veem meu progresso?', a: 'Por padrão seu perfil é visível pros seus amigos. Você pode deixá-lo privado a qualquer momento — aí só nome, foto e mensagem continuam visíveis.' },
      { q: 'Tem restrição de idade?', a: 'Sim, o app é destinado a maiores de 18 anos — o cadastro pede a idade.' },
    ],
  ...
  en: {
    ...
    faq: [
      ...
      { q: 'Can my friends see my progress?', a: "By default your profile is visible to your friends. You can make it private anytime — only your name, photo, and bio stay visible after that." },
      { q: 'Is there an age requirement?', a: "Yes, the app is intended for people 18 and older — signup asks for your age." },
    ],
